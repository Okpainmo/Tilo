  ...
  return (
    <>
      <div className="theme-switcher flex items-center">
        ...
        <button
          type="button"
          className={`light-mode-switch cursor-pointer text--colors_secondary ${
            isLight && 'hidden'
          }`}
      ...
      {/* <div className="theme-switches">
       <div
         className={`light-theme-switch cursor-pointer ${isLight && 'hidden'}`}
         onClick={setLightMode}
       >
         <span className="light-high">
           <svg
             xmlns="http://www.w3.org/2000/svg"
             width="20"
             height="20"
       ...
       <div
         className={`dark-theme-switch cursor-pointer ${!isLight && 'hidden'}`}
         onClick={setDarkMode}
       >
         <span className="dark-high">
           <svg
             xmlns="http://www.w3.org/2000/svg"
             width="20"
             height="20"
