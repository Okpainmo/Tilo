...
function BottomNavbar() {
  ...
  return (
    <nav
      className="bg--default lg:hidden w-full py-2 px-3 sm:px-8 md:py-4 lg:px-16 flex justify-between
    z-20 items-center montserrat fixed bottom-0 left-0 right-0"
    >
      <Link href="/">
        <a className="flex flex-col gap-[2px] items-center text--colors_primary">
          ...
          <span className="text--colors_primary text-[12px]">Home</span>
        </a>
      </Link>
      <Link href="/coins-watchlist">
        <a
          onClick={loadingWatchlist}
          className="flex flex-col gap-[2px] items-center text--colors_primary"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <span className="text--colors_primary text-[12px]">Watchlist</span>
        </a>
      </Link>
      ...
      <Link href="sign-in">
        <a className="flex flex-col gap-[2px] items-center text--colors_primary">
          ...
          <span className="text--colors_primary text-[12px]">Account</span>
        </a>
      </Link>
    </nav>
  );
