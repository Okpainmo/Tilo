...
function CoinPage({ coinDetails }) {
  ...
  return (
    <MainAppLayout>
      <main className="coin-details-page px-[12px] xsm:px-4 sm:w-4/5 sm:mx-auto lg:w-3/5">
        ...
        <section className="flex flex-col gap-4 mt-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-y-6">
            <div className="flex flex-col">
              ...
              >
                {market_data.price_change_percentage_1h_in_currency.usd.toFixed(2)}%
              </span>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              >
                {market_data.price_change_percentage_30d_in_currency.usd.toFixed(2)}%
              </span>
            </div>
            <div className="flex flex-col">
        ...
        <section className="mt-12">
          ...
          <div className="pt-2">{description.en}</div>
        </section>
      </main>
    </MainAppLayout>
  );
